...
output_dir<-paste0(output_dir, "Product reallocation and firm dynamics/Export 09.11/cpa/")
...
product_data_pc<-readRDS(paste0("product_level_growth_", filter_indicator,  "_.RDS"))
...
product_data_temp<-unique(product_data_temp[exit_10==T, c("firmid", "year", "prodcom_rev")])
