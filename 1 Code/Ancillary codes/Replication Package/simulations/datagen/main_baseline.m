...
filename = 'firm_panel_baseline'; % calibration based on data
...
for Nk = [8]; for sigma_z = [0.2]; for rho_z=[0.6]; for sigma = [1.1]; for eta = [1.1]; for gamma = [0.8]; for alpha = [0.4]; for N_tot = [320000]; for sigma_wage=[sqrt(.06)]; for sigma_PsigmaY=[sqrt(0.19)]  % huge sample, also for Monte Carlo
