...
vars_labs <- fread("var, lab
                   dev_from_mean, Dev. from Av. Share of Bursts per Year
                   value, Share of Bursts per Year")
...
pat_vars_to_mean <- names(patenting_products)[grepl("pat_families_dummy", names(patenting_products))]
